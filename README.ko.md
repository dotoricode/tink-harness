...
**최신 패키지:** v1.12.0 — 검증 후 사람이 읽기 쉬운 evidence card를 남기고, strict 완료 정책의 “no evidence, no done” 기반을 추가했습니다. 대시보드에는 하네스 신뢰도, ROI, 실패/차단 run 복기 카드가 표시됩니다. 전체 변경 이력은 [CHANGELOG](CHANGELOG.md)를 확인하세요.
