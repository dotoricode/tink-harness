...
9. Ask for approval before applying, saving, purging, or honing.
10. After approval, create `.tink/current/plan.md`, `checks.md`, `steps.json`, `notes.md`, and `answers.md`.
11. Do not stop at recommendation. Execute the first safe step after run state exists.
